...
#pragma endregion
#define ID_ANI_PLANT_GP 6005100 //Green Piranha Plant
#define ID_ANI_PLANT_GVF 6005200 //Green Venus Fire Trap
#define ID_ANI_PLANT_RVF 6005300 //Red Venus Fire Trap
