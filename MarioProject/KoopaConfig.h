...
constexpr float KOOPA_SHELL_SPEED = 3.5f * 0.0625f;
constexpr float KOOPA_PARATROOPA_ACCELERATION_Y = 0.000085f;

constexpr float KOOPA_MAX_VY = (KOOPA_PARATROOPA_ACCELERATION_Y * 1000.f); // fly range;
